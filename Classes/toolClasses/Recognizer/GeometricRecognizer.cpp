...
namespace DollarRecognizer
{
	...
	void GeometricRecognizer::loadTemplates()
	{
        ...
        addTemplate("Fish", samples.getGestureFish());
        addTemplate("Lollipop", samples.getGestureLollipop());
        addTemplate("Dollar", samples.getGestureDollar());
	...
	void   GeometricRecognizer::setRotationInvariance(bool ignoreRotation)
	{
		...
		{
			angleRange = 5.0;                  //角度误差值，值越大形状包容性越大，值越小形状越具有唯一性，根据具体需求自行改变，这里将原来的15降到5
		}
	}
